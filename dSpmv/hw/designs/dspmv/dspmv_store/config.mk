...
NETLAYERDIR = $(XFLIB_DIR)/xans/hw/vnx/NetLayers
CMACDIR     = $(XFLIB_DIR)/xans/hw/vnx/Ethernet
XSA := $(DEVICE)
TEMP_DIR := _x.$(XSA)
...
POSTSYSLINKTCL ?= $(shell readlink -f $(XFLIB_DIR)/xans/hw/vnx/Ethernet/post_sys_link.tcl)
