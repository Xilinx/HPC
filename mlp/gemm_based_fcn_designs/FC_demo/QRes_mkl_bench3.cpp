...
int main(int argc, char** argv) {
    ...
    data_dir = data_dir + "/";
    string NNfile = "NN356.bin", InputsFile = "NN356inputs.bin", OutputsFile = "NN356outputs.bin";
    ...
    XFBLAS_dataType *InputTable, *InputTable2, *OutputTable, *OnesTraces, alpha = 1.,
                                                                                                    beta = 1.;
    ...
    for (int ll = 0; ll < LoopCount; ll++) {
        ...
        for (int kn = 0; kn <= NNnumber - 1; kn++) {
            ...
            GEMM_MKL(L1size, NNtraces, 1, alpha, beta, l_b1, l_OnesTraces,
            ...
            GEMM_MKL(L1size, NNtraces, NNinputs, alpha, beta, l_IW, l_InputTable,
            ...
            GEMM_MKL(L2size, NNtraces, 1, alpha, beta, l_b2, l_OnesTraces,
            ...
            GEMM_MKL(L2size, NNtraces, L1size, alpha, beta, l_LW21, L1temp,
            ...
            GEMM_MKL(NNoutputs, NNtraces, 1, alpha, beta, l_b3, l_OnesTraces,
            ...
            GEMM_MKL(NNoutputs, NNtraces, L2size, alpha, beta, l_LW32, L2temp,
