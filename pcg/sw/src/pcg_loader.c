...
void destroy_JPCG_handle(void* handle) {
    ...
    if (pDestroyFunc) pDestroyFunc(handle);
}
...
void JPCG_coo(void* handle,
              ...
              uint32_t* p_iter,
              double* p_res) {
    typedef void (*ApiFunc)(void*, JPCG_Mode, uint32_t, uint32_t, uint32_t*, uint32_t*, double*, double*, double*,
                            double*, uint32_t, double, uint32_t*, double*);
