...
XJPCG_Status_t xJPCG_createHandle(XJPCG_Handle_t* handle, int deviceId, const char* xclbinPath) {
    ...
    if (!pCreateFunc) return XJPCG_STATUS_NOT_SUPPORTED;
...
XJPCG_Status_t xJPCG_destroyHandle(XJPCG_Handle_t* handle) {
    ...
    if (!pDestroyFunc) return XJPCG_STATUS_NOT_SUPPORTED;
...
XJPCG_Status_t xJPCG_cooSolver(XJPCG_Handle_t* handle,
    ...
    typedef XJPCG_Status_t (*ApiFunc)(XJPCG_Handle_t*, uint32_t, uint32_t, const uint32_t*, const uint32_t*,
                                      const double*, const double*, const double*, const double*, const uint32_t,
                                      const double, uint32_t*, double*, const XJPCG_Mode);
    ApiFunc pApiFunc = (ApiFunc)xilinx_apps_getCDynamicFunction("xJPCG_cooSolver");
    if (!pApiFunc) return XJPCG_STATUS_NOT_SUPPORTED;
