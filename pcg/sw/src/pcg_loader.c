...
XILINX_PCG_LINKAGE_DEF
XJPCG_Status_t xJPCG_createHandle(XJPCG_Object_t **handle, int deviceId, const char *xclbinPath) {
    typedef XJPCG_Status_t (*CreateFunc)(XJPCG_Object_t**, int, const char *);
...
XJPCG_Status_t xJPCG_destroyHandle(XJPCG_Object_t *handle) {
    typedef XJPCG_Status_t (*DestroyFunc)(XJPCG_Object_t *);
...
XJPCG_Status_t xJPCG_getMetrics(const XJPCG_Object_t *handle, XJPCG_Metric_t *metric){
    typedef XJPCG_Status_t (*GetMetrics)(const XJPCG_Object_t *, XJPCG_Metric_t *);
...
XJPCG_Status_t xJPCG_peekAtLastStatus(const XJPCG_Object_t *handle) {
    typedef XJPCG_Status_t (*PeekAtLastStatus)(const XJPCG_Object_t *);
...
const char* xJPCG_getLastMessage(const XJPCG_Object_t *handle) {
    typedef const char* (*GetLastMessage)(const XJPCG_Object_t *);
...
XJPCG_Status_t xJPCG_cscSymSolver(XJPCG_Object_t *handle, 
    ...
    typedef XJPCG_Status_t (*ApiFunc)(XJPCG_Object_t *,  uint32_t, uint32_t, const uint64_t*, const uint64_t*, const double*, const double*, const double*, const double*, const uint32_t, const double, uint32_t*, double*, const XJPCG_Mode);
...
XJPCG_Status_t xJPCG_cooSolver(XJPCG_Object_t *handle, 
        ...
        double *p_res,
        const XJPCG_Mode mode) {
    typedef XJPCG_Status_t (*ApiFunc)(const XJPCG_Object_t *,  uint32_t, uint32_t, const uint32_t*, const uint32_t*, const double*, const double*, const double*, const double*, const uint32_t, const double, uint32_t*, double*, const XJPCG_Mode);
