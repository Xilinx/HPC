...
namespace mlp {
    ...
    class PyMLPWrapper : public MLPBase {
        public:
            ...
            void setLayer(const uint32_t p_modelId, const uint32_t p_layerId, py::array_t<HPC_dataType> p_weights, py::array_t<HPC_dataType> p_bias) {
            ...
            double predict(HOST_BUFFER_TYPE &p_x, HOST_BUFFER_TYPE &p_y, const uint32_t p_modelId=0, const uint32_t p_cuId=0) {
